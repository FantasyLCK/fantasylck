...
class PointComparisonLogic(RosterComparisonLogic):
    ...
    def determine_winner(self) -> Fraction:
        ...
        top1_points, top2_points = self.__determine_points(
            PointComparisonLogic.TOP_POINTS,
            self._user1.top,
            self._user2.top,
            p1_single_team,
            p2_single_team,
        )
        jgl1_points, jgl2_points = self.__determine_points(
            PointComparisonLogic.JGL_POINTS,
            self._user1.jgl,
            self._user2.jgl,
            p1_single_team,
            p2_single_team,
        )
        mid1_points, mid2_points = self.__determine_points(
            PointComparisonLogic.MID_POINTS,
            self._user1.mid,
            self._user2.mid,
            p1_single_team,
            p2_single_team,
        )
        adc1_points, adc2_points = self.__determine_points(
            PointComparisonLogic.ADC_POINTS,
            self._user1.adc,
            self._user2.adc,
            p1_single_team,
            p2_single_team,
        )
        sup1_points, sup2_points = self.__determine_points(
            PointComparisonLogic.SUP_POINTS,
            self._user1.sup,
            self._user2.sup,
            p1_single_team,
            p2_single_team,
